...
export const CartActions = memo(function CartActions({
    ...
    return (
        <div className="p-8 bg-[var(--onyx-surface)] flex flex-col gap-3 border-t border-white/5">
            {/* Send to Kitchen */}
            <button
                type="button"
                className={cn(
            ...
            <div className="grid grid-cols-2 gap-3">
                <button
                    type="button"
                    className="py-3 rounded-xl text-[10px] uppercase font-bold tracking-widest cursor-pointer flex items-center justify-center gap-2 border border-white/10 bg-transparent text-[var(--stone-text)] hover:text-white hover:bg-white/5 transition-all"
                >
                    <Receipt size={14} />
                    Receipt
                </button>
