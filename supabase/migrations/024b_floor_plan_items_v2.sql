-- Migration: Floor Plan Items (Tables + Decorations) - Version 2
...
CREATE INDEX idx_floor_plan_items_type ON public.floor_plan_items(type);
CREATE INDEX idx_floor_plan_items_section ON public.floor_plan_items(section) WHERE type = 'table';
CREATE INDEX idx_floor_plan_items_status ON public.floor_plan_items(status) WHERE type = 'table';
CREATE INDEX idx_floor_plan_items_number ON public.floor_plan_items(number) WHERE type = 'table';
