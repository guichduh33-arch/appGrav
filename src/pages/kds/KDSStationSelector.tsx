...
export default function KDSStationSelector() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a] text-white">
            <header className="flex items-center justify-between py-5 px-8 bg-[#2a2a2a] border-b border-[#333] max-md:px-5 max-md:py-4">
                <button
                    className="bg-[#333] border-none text-white w-12 h-12 rounded-xl flex items-center justify-center cursor-pointer transition-all duration-200 hover:bg-[#444] hover:scale-105"
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-[1.75rem] font-bold text-pink-300 m-0">The Breakery</h1>
            ...
            <main className="flex-1 flex flex-col items-center justify-center p-10">
                ...
                <div className="grid grid-cols-2 max-md:grid-cols-1 gap-6 max-w-[900px] w-full">
                    {STATIONS.map((station) => (
                        <button
                            key={station.id}
                            className="bg-[#2a2a2a] border-2 border-[#333] rounded-[20px] p-8 max-md:p-6 cursor-pointer flex items-center gap-6 transition-all duration-300 text-left hover:bg-[#333] hover:-translate-y-1 hover:shadow-[0_10px_40px_rgba(0,0,0,0.3)] active:translate-y-0"
            ...
            <footer className="py-5 text-center border-t border-[#333] text-gray-600 text-[0.9rem]">
