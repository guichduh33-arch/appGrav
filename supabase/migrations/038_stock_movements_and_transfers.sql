-- Migration: Stock Movements and Internal Transfers
-- Description: Track stock movements between main warehouse and sections
-- Date: 2026-01-20
...
CREATE TABLE IF NOT EXISTS public.stock_movements (
    ...
    movement_type TEXT NOT NULL CHECK (movement_type IN (
        'transfer',           -- Transfert entre localisations
        'adjustment',         -- Ajustement d'inventaire
        'production_input',   -- Entrée de production
    ...
    -- References
    reference_type TEXT CHECK (reference_type IN ('purchase_order', 'transfer', 'production', 'sale', 'adjustment', 'waste')),
    reference_id UUID,
...
GRANT ALL ON public.stock_movements TO public;
...
COMMENT ON TABLE public.stock_movements IS 'Audit trail of all stock movements between locations';
